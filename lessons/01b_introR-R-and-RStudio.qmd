...
> Note: If you are using these materials for a locally installed version of RStudio, please use [this lesson](01a_introR-R-and-RStudio.html) instead.
...
Left-click the "Join" Button and it will take you to a webpage that looks like the one below:
...
Left-click on the Hamburger button in the top left to reveal your available workspaces.

<img src="../img/Open_hamburger_2_annotated.png" width="600"/>

On the top of the left-hand panel you should see a section called "Spaces". Within it you should see three options:
...
> Note: We have instructions on how to create an RStudio project locally in [this lesson](01a_introR-R-and-RStudio.html#create-a-new-project-directory-in-rstudio).

> Note: Once you have opened the "Intro-to-R" on Posit Cloud for the first time, it will make a derived duplicate of the project that you are working on in our **Introduction to R** Workspace. In the future, you can click on either R project to come back to the point where you left off.

The RStudio interface should now look like this:

<img src="../img/Initial_state_annotated.png" width="800"/>

Next, we are going to create an Rscript to keep a record of our work, but first we will implement good data management practices and create a folder to hold this script. In the bottom-right panel there should be a button that has a folder with a green plus on it and says "New Folder", left-click this button:

<img src="../img/New_folder.png" width="800"/>

> Note: Depending on the size of your window, the "New Folder" button may just have the icon or the icon and the word "Folder".

A window should pop-up prompting you to provide a name for the folder. Type "scripts" into the text box and left-click "OK":
...
Now we will create the Rscript that we will write our code in. In order to create an Rscript, left-click "File" in the top-left, then "New File" and then left-click "R Script".
...
Before we go any further, let's save our new R Script by left-clicking "File" in the top-left and left-clicking "Save As...".

<img src="../img/Save_as_annotated.png" width="800"/>

We are going to place this new R Script within our newly created "scripts" folder, so left-click the "scripts" folder.

<img src="../img/Select_scripts_folder_annotated.png" width="800"/>

Let's name our R Script as "Intro-to-R.R" in the text field and left-click "Save".
...
> Note: If you wanted to add files onto the Posit Cloud server you could do this with the "Upload" button in the "Files" tab.

> Note: Adding files when working in RStudio locally is a bit different. Please reference [this lesson](01a_introR-R-and-RStudio.html#adding-files-to-your-working-directory) for instructions to do this.
