...
| 10:30 - 11:45 | [Introduction to R and RStudio](01_introR-R-and-RStudio.qmd) | Elizabeth |
...
I. Please **study the contents** and **work through all the code** within the following lessons:
   ...
   1. [R Syntax and Data Structure](02_introR-syntax-and-data-structures.qmd)
      <details>
...
| 10:50 - 11:15 | [In-class exercises](../activities/Day2_activities.qmd) + [Answer key](../activities/Day2_activities_answer_key.R) | Elizabeth |
...
I. Please **study the contents** and **work through all the code** within the following lessons:
   ...
   2. [Data wrangling: data frames, matrices and lists](07_introR-data-wrangling2.qmd)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   5. [Setting up a data frame to plot (+ the `map()` function)](10_setting_up_to_plot.qmd)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
...
I. Please **study the contents** and **work through all the code** within the following lessons:
   ...
   1. [Using custom functions for consistent plots](11b_Custom_Functions_ggplot2.qmd)
      <details>
        <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   3. [Writing to file and exporting plots](13_exporting_data_and_plots.qmd)
         <details>
            <summary><i>Click here for a preview of this lesson</i></summary>
...
|:------------------------:|:------------------------------------------------:|:--------:|
| 10:00 - 10:35 | Questions about self-learning lessons | All |
| 10:35 - 11:15 | [In-class exercises](../activities/Day4_activities.qmd) + [Answer key](../activities/Day4_activities_answer_key.R) | Will |
| 11:15 - 11:45 | Discussion, Q & A | All |
| 11:45 - 12:00 | [Wrap Up](../slides/workshop_intro_slides.pdf) | Will |
...
* [**Final exercises**](https://hbctraining.github.io/Intro-to-R/homework/Intro_to_R_key.qmd)
...
## Resources
* [Online learning resources](https://hbctraining.github.io/bioinformatics_online/lists/online_trainings.qmd)
