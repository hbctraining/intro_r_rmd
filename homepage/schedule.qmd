...
| 10:30 - 11:45 | [Introduction to R and RStudio](../docs/01_introR-R-and-RStudio.html) | Elizabeth |
...
I. Please **study the contents** and **work through all the code** within the following lessons:
   ...
   1. [R Syntax and Data Structure](../docs/02_introR-syntax-and-data-structures.html)
      <details>
   ...
   2. [Functions and Arguments](../docs/03_introR-functions-and-arguments.html)
      <details>
       <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   3. [Reading in and inspecting data](../docs/06_reading_and_data_inspection.html)
      <details>
       <summary><i>Click here for a preview of this lesson</i></summary>
...
| 10:50 - 11:15 | [In-class exercises](../activities/Day2_activities.html) + [Answer key](../activities/Day2_activities_answer_key.R) | Elizabeth |
| 11:15 - 12:00 | [Data Wrangling: Subsetting Vectors and Factors](../docs/05_introR-data-wrangling.html) | Will |

### Before the next class:

I. Please **study the contents** and **work through all the code** within the following lessons:

   1. [Packages and libraries](../docs/04_introR_packages.html)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   2. [Data wrangling: data frames, matrices and lists](../docs/07_introR-data-wrangling2.html)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   3. [The %in% operator](../docs/08_identifying-matching-elements.html)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   4. [Reordering and matching](../docs/09_reordering-to-match-datasets.html)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   5. [Setting up a data frame to plot (+ the `map()` function)](../docs/10_setting_up_to_plot.html)
       <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
...
| 10:35 - 11:15 | [In-class exercises](../activities/Day3_activities.html) + [Answer key](../activities/Day3_activities_answer_key.R)| Will |
| 11:15 - 12:00 | [Plotting with the ggplot2 package](../docs/11_ggplot2.html) | Elizabeth |

### Before the next class:

I. Please **study the contents** and **work through all the code** within the following lessons:

   1. [Using custom functions for consistent plots](../docs/11b_Custom_Functions_ggplot2.html)
      <details>
        <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   2. [Generating a boxplot with ggplot2](../docs/12_boxplot_exercise.html)
        <details>
         <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   3. [Writing to file and exporting plots](../docs/13_exporting_data_and_plots.html)
         <details>
            <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   4. [Finding help](../docs/14_finding_help.html)
         <details>
            <summary><i>Click here for a preview of this lesson</i></summary>
   ...
   6. [Tidyverse](../docs/15_tidyverse.html)
         <details>
            <summary><i>Click here for a preview of this lesson</i></summary>
...
|:------------------------:|:------------------------------------------------:|:--------:|
| 10:00 - 10:35 | Questions about self-learning lessons | All |
| 10:35 - 11:15 | [In-class exercises](../activities/Day4_activities.html) + [Answer key](../activities/Day4_activities_answer_key.R) | Will |
